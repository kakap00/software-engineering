  ...
  return (
    <div className='singlePageMainParent relative top-36'>
      ...
      <div className='bottomImgHold flex flex-row relative gap-8'>
        <img src='https://secureadmin19cdfx.thebodyshop.in/pub/media/img/About%20Us%20-%20Natura%20&%20Co%20-%20United%20by%20purpose%201.webp' className=' w-80 si cursor-pointer object-cover' onMouseEnter={imgSrcTarget} onMouseLeave={defaultImageSrc} />
        <img src='https://bodyshop-magento-staging.s3.amazonaws.com/media/wysiwyg/tips-and-advice/skincare/UK-2023-Q1-Skin-concerns-CT10-5.jpg' className=' w-80 si cursor-pointer object-cover' id='mobileDontSHow' onMouseEnter={imgSrcTarget} onMouseLeave={defaultImageSrc} />
      </div>
